...
visible PurpleMux-managed Bash tab. AWM saves bounded terminal output in Run
history and detail (combined in stdout for visible terminals), alongside
structured Progress, Findings, bounded failure
